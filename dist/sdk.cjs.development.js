...
var ConstantProductPool = /*#__PURE__*/function () {
  function ConstantProductPool(currencyAmountA, currencyAmountB, fee, twap) {
    ...
    this.liquidityToken = new Token(currencyAmounts[0].currency.chainId, ConstantProductPool.getAddress(currencyAmounts[0].currency, currencyAmounts[1].currency, fee, twap), 18, 'CLP', 'Candle LP Token');
    this.fee = fee;
    this.twap = twap;
...
exports.CANDLE_ADDRESS = CANDLE_ADDRESS;
